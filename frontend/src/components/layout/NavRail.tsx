/**
 * NavRail — left navigation/control rail.
 *
 * Owns shared controls that affect all views:
 *   - selection cursor (time, freq, spatial)
 *   - layout preset switcher
 *   - processing pipeline settings
 *
 * Reads navigation state from the shared stores.
 * Mutation callbacks that require server round-trips are passed as props
 * so that query invalidation stays in one place (App.tsx).
 */
...
export function NavRail({ onCommitSelection }: NavRailProps) {
